...
export const team = [
  {
    ...
    bio: 'Visionary leader with 15+ years of experience in software development and digital transformation. Passionate about building innovative solutions that solve real-world problems.',
    longBio: 'Alex founded Prodvestor with a vision to bridge the gap between technology and business needs. With a background in computer science and an MBA, Alex brings both technical expertise and business acumen to lead the company. Under his leadership, Prodvestor has grown from a small startup to a trusted technology partner for businesses worldwide.',
    image: '/assets/images/team/alex-thompson.jpg',
    email: 'alex@prodvestor.com',
  ...
  },
  {
    ...
    longBio: 'Sarah brings over 12 years of experience in software architecture and cloud computing. Before joining Prodvestor, she led engineering teams at Fortune 500 companies, designing systems that handle millions of users. She\'s passionate about mentoring developers and staying at the forefront of technology trends.',
  ...
  },
  {
    ...
    longBio: 'Michael is a versatile developer who excels at both frontend and backend development. With 10 years of experience, he has worked on projects ranging from startups to enterprise applications. He loves solving complex problems and mentoring junior developers.',
    image: '/assets/images/team/michael-rodriguez.jpg',
    email: 'michael@prodvestor.com',
