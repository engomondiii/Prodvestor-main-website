        ...
        <div className="footer__main">
          ...
          <div className="footer__column footer__column--brand">
            ...
            <p className="footer__description">
              Connecting elite software developers from emerging markets with global opportunities while building innovative technology solutions.
            </p>
            ...
            <div className="footer__social">
              ...
              <a href={COMPANY.social.github} target="_blank" rel="noopener noreferrer" className="footer__social-link" aria-label="GitHub">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
